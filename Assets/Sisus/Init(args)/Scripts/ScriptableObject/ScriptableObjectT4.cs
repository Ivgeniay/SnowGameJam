...
namespace Sisus.Init
{
	...
	/// or <see cref="ObjectExtensions.Instantiate{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument}">instantiated</see>
	...
	public abstract class ScriptableObject<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument> : ScriptableObject, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
	{
		#if DEBUG
		/// <summary>
