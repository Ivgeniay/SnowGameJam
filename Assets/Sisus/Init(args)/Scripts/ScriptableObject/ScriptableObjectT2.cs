...
namespace Sisus.Init
{
	...
	/// or <see cref="ObjectExtensions.Instantiate{TFirstArgument, TSecondArgument}">instantiated</see>
	...
	public abstract class ScriptableObject<TFirstArgument, TSecondArgument> : ScriptableObject, IInitializable<TFirstArgument, TSecondArgument>
	{
		#if DEBUG
		/// <summary>
