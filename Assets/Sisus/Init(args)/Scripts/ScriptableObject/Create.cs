...
namespace Sisus.Init
{
    ...
    public static class Create
    {
		...
		/// and did not manually handle receiving the provided arguments.
		/// </exception>
		public static void Instance<TScriptableObject, TArgument>(out TScriptableObject instance, TArgument argument)
			where TScriptableObject : ScriptableObject, IArgs<TArgument>
		...
		/// </exception>
		public static TScriptableObject Instance<TScriptableObject, TFirstArgument, TSecondArgument>
			(out TScriptableObject instance, TFirstArgument firstArgument, TSecondArgument secondArgument)
				where TScriptableObject : ScriptableObject, IArgs<TFirstArgument, TSecondArgument>
		...
		/// </exception>
		public static TScriptableObject Instance<TScriptableObject, TFirstArgument, TSecondArgument, TThirdArgument>
			(out TScriptableObject instance, TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument)
				where TScriptableObject : ScriptableObject, IArgs<TFirstArgument, TSecondArgument, TThirdArgument>
		...
		/// </exception>
		public static TScriptableObject Instance<TScriptableObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
			(out TScriptableObject instance, TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument)
				where TScriptableObject : ScriptableObject, IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>
		...
		/// Thrown if <typeparamref name="TScriptableObject"/> class does not implement <see cref="IInitializable{TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument}"/> and did not manually handle receiving the provided arguments. 
		/// </exception>
		public static TScriptableObject Instance<TScriptableObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
			(out TScriptableObject instance, TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument, TFifthArgument fifthArgument)
				where TScriptableObject : ScriptableObject, IArgs<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
					=> instance = Instance<TScriptableObject, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument);
	}
}