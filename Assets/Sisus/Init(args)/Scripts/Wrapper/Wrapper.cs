...
namespace Sisus.Init
{
    ...
    public abstract class Wrapper<TWrapped> : MonoBehaviour, IWrapper<TWrapped>, IValueProvider<TWrapped>, ICoroutineRunner
    {
        /// <summary>
		...
		/// <para>
		/// <see cref="Reset"/> is called when the user selects Reset in the Inspector context menu or when adding the component the first time.
		/// </para>
		/// <para>
