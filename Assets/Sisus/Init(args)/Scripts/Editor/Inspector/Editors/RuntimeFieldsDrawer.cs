...
namespace Sisus.Init
{
    ...
    public sealed class RuntimeFieldsDrawer
    {
        ...
        private static List<FieldInfo> GetRuntimeFields(Type type, [CanBeNull] Type stopAtBaseType)
        {
            ...
            while(type != stopAtBaseType && type != null && (stopAtBaseType == null || !stopAtBaseType.IsGenericTypeDefinition || !type.IsGenericType || type.GetGenericTypeDefinition() != stopAtBaseType));
