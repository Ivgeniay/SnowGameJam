...
namespace Sisus.Init.EditorOnly
{
	public sealed class InitializerDrawer : IDisposable
	{
		...
		static InitializerDrawer() => genericInspectorType = typeof(Editor).Assembly.GetType("UnityEditor.GenericInspector");

		public InitializerDrawer(Type clientType, Object[] targets, Type[] initParameterTypes, Editor initializerEditor = null, GameObject[] gameObjects = null)
		{
