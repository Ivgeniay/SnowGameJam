...
namespace Sisus.Init
{
	...
	public abstract class WrapperInitializerBase<TWrapper, TWrapped, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument> : MonoBehaviour
		, IInitializer<TWrapped, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument>, IValueProvider<TWrapped>
		#if UNITY_EDITOR
		...
		where TWrapper : Wrapper<TWrapped>
	{
		...
		public TWrapped InitTarget()
		{
			...
			if(target is IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument> initializable && GetOrCreateUnitializedWrappedObject() is var wrappedObject)
			{
