...
namespace Sisus.Init
{
	...
	public abstract class StateMachineBehaviourInitializerBase<TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument> : MonoBehaviour
		, IInitializer<TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, IValueProvider<TStateMachineBehaviour>
		#if UNITY_EDITOR
		...
		where TStateMachineBehaviour : StateMachineBehaviour, IInitializable<TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>
	{
		...
		public TStateMachineBehaviour InitTarget()
		{
			...
			return InitTarget(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument);
		}
		...
		/// </returns>
		[NotNull]
		protected virtual TStateMachineBehaviour InitTarget(TFirstArgument firstArgument, TSecondArgument secondArgument, TThirdArgument thirdArgument, TFourthArgument fourthArgument, TFifthArgument fifthArgument)
        {
			Animator animator = target;
			if(target.gameObject != gameObject)
			{
				InitArgs.Set<TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>(firstArgument, secondArgument, thirdArgument, fourthArgument, fifthArgument);
				animator = Instantiate(target);
				if(!InitArgs.Clear<TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>())
				{
		...
		protected virtual void Validate()
		{
			...
			ValidateTargetOnMainThread<StateMachineBehaviourInitializerBase<TStateMachineBehaviour, TFirstArgument, TSecondArgument, TThirdArgument, TFourthArgument, TFifthArgument>, TStateMachineBehaviour>(this);
			#endif
		}
