...
namespace Init.Demo
{
    ...
    {
        private readonly Dictionary<GameObject, Vector2Int> aliveInstances = new Dictionary<GameObject, Vector2Int>();
        ...
        /// </summary>
        public Spawner([NotNull] SpawnerSettings settings, [NotNull] ITrackable playerTrackable, [NotNull] ILevel level, [NotNull] ITimeProvider timeProvider, [NotNull] IBuilder<GameObject> gameObjectBuilder)
        {
        ...
        {
            return timeProvider.Time + Random.Range(settings.MinSpawnInterval, settings.MaxSpawnInterval);
        }
        ...
        private bool IsValidSpawnPosition(Vector2Int position)
        {
            ...
            if(Vector2Int.Distance(GetPlayerPosition(), position) < minDistance)
            {
                return false;
            }
