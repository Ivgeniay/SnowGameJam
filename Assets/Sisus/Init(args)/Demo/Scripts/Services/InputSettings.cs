...
namespace Init.Demo
{
    ...
    /// </summary>
    [Service(typeof(IInputSettings), ResourcePath = Name)]
    [Service(typeof(IResetInputSettings), ResourcePath = Name)]
    [Service(typeof(IMoveInputSettings), ResourcePath = Name)]
